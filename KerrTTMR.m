...
Module[{\[Omega],Alm},
	\[Omega]=SetPrecision[-(2^(2/3)3^(1/3)a^(-4/3)+(4/3l-2)/a
		...
		+(6261-4545l+171l^2-38l^3)/(1296 2^(1/3) 3^(2/3))a^(-1/3)
		+(225-340l+178l^2-44l^3+4l^4)/576)I,$MinPrecision];
	Alm=SetPrecision[(2l-3)(I \[Omega] a)
		+1/4+3/2*l-1/2l^2
		-((2l-3)(l^2-3l-59)/16)(1/(2^(2/3) 3^(1/3))a^(1/3)
		+(1/(2^(1/3) 3^(2/3))-1/3(2/3)^(2/3))a^(2/3))
		+(43/2-725/16l+16l^2-5/8l^3)(1/(2 2^(1/3) 3^(2/3))a^(2/3)),$MinPrecision];
	{\[Omega],Alm}
]
