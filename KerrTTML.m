...
Module[{C12tmp,C1,C2,C3,C4,C5,Rem,Err},
	...
	C4=(-3/(32*C1)-s^2/(2*C1)+((9*I)*\[Omega])/(Sqrt[1 - a^2]*C1)-(9*I)*a^2*\[Omega])/(Sqrt[1 - a^2]*C1)+(3*a*m*\[Omega])/C1 - (28*\[Omega]^2)/C1 + (51*a^2*\[Omega]^2)/(2*C1) - (28*\[Omega]^2)/(Sqrt[1 - a^2]*C1) + (28*a^2*\[Omega]^2)/(Sqrt[1 - a^2]*C1) + ((16*I)*a*m*\[Omega]^2)/C1 + ((8*I)*a*m*\[Omega]^2)/(Sqrt[1 - a^2]*C1) - ((8*I)*a^3*m*\[Omega]^2)/(Sqrt[1 - a^2]*C1) - ((64*I)*\[Omega]^3)/C1 + ((32*I)*a^2*\[Omega]^3)/C1 - ((64*I)*\[Omega]^3)/(Sqrt[1 - a^2]*C1) + ((68*I)*a^2*\[Omega]^3)/(Sqrt[1 - a^2]*C1) - ((4*I)*a^4*\[Omega]^3)/(Sqrt[1 - a^2]*C1) - (s*(Sqrt[1 - a^2] - (8*I)*(-1 + a^2)*\[Omega]))/(2*Sqrt[1 - a^2]*C1) -(Alm*(Sqrt[1 - a^2] + (8*I)*(-1 + a^2)*\[Omega]))/(2*Sqrt[1 - a^2]*C1))/ (((8*I)*\[Omega])/(Sqrt[1 - a^2]*C1) - ((8*I)*a^2*\[Omega])/(Sqrt[1 - a^2]*C1));
	C5=-(21/64 -(((9*I)/64)*a*m)/Sqrt[1 - a^2] - ((63*I)/4096)/(Sqrt[1 - a^2]*\[Omega]) + ((I/16)*Alm^2)/(Sqrt[1 - a^2]*\[Omega]) + ((I/16)*s^4)/(Sqrt[1 - a^2]*\[Omega]) + ((3*I)/8)*\[Omega] + (((117*I)/8)*\[Omega])/Sqrt[1 - a^2] - (((1773*I)/128)*a^2*\[Omega])/Sqrt[1 - a^2] + (15*a*m*\[Omega])/2 - (((7*I)/4)*a^2*m^2*\[Omega])/Sqrt[1 - a^2] - 36*\[Omega]^2 + (35*a^2*\[Omega]^2)/4 - (36*\[Omega]^2)/Sqrt[1 - a^2] + (36*a^2*\[Omega]^2)/Sqrt[1 - a^2] + (20*I)*a*m*\[Omega]^2 + ((20*I)*a*m*\[Omega]^2)/Sqrt[1 - a^2] - (((15*I)/4)*a^3*m*\[Omega]^2)/Sqrt[1 - a^2] - (64*I)*\[Omega]^3 + (10*I)*a^2*\[Omega]^3 - ((64*I)*\[Omega]^3)/Sqrt[1 - a^2] + ((42*I)*a^2*\[Omega]^3)/Sqrt[1 - a^2] - (((7*I)/16)*a^4*\[Omega]^3)/Sqrt[1 - a^2] + (s^3*(I + 4*Sqrt[1 - a^2]*\[Omega]))/(8*Sqrt[1 - a^2]*\[Omega]) + ((I/128)*s^2*(-1 + 32*((-9*I)*Sqrt[1 - a^2] + a*m)*\[Omega] +  16*(-24 + 13*a^2 + 16*Sqrt[1 - a^2])*\[Omega]^2))/(Sqrt[1 - a^2]*\[Omega]) + (s*(-9*I + 4*(59*Sqrt[1 - a^2] - (24*I)*a*m)*\[Omega] +  16*((13*I)*a^2 + (8*I)*(-1 + 2*Sqrt[1 - a^2]) + 8*a*Sqrt[1 - a^2]*m)*\[Omega]^2 + 64*(-16*(1 + Sqrt[1 - a^2]) + a^2*(16 + 5*Sqrt[1 - a^2]))*\[Omega]^3))/(128*Sqrt[1 - a^2]*\[Omega]) + (I/128)*Alm*(-9 + 16*s^2 + ((-224*I)*Sqrt[1 - a^2] - 96*a*m)*\[Omega] + 16*(16 - 11*a^2 + 16*Sqrt[1 - a^2])*\[Omega]^2 + 16*s*(1 - (4*I)*Sqrt[1 - a^2]*\[Omega])))/(Sqrt[1 - a^2]*\[Omega]))/(2*C1);
